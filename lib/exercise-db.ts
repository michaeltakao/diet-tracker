...
/**
 * Builds a `video: { type: 'local-gif', ... }` entry pointing at a static
 * JPG under public/exercise-media/. Source: free-exercise-db (The
 * Unlicense, public domain) — see public/exercise-media/README.md for
 * provenance and the exact-name-match-only mapping rationale (no fuzzy
 * matching: a wrong-exercise image is worse than no image for a workout-
 * form guide).
 */
function localGif(slug: string): ExerciseVideo {
  return { type: 'local-gif', url: `/exercise-media/${slug}.jpg` };
}
...
const CHEST_EXERCISES: readonly ExerciseDef[] = [
  ...
  { id: 'incline-dumbbell-press', nameJa: 'インクラインダンベルプレス', nameEn: 'Incline Dumbbell Press', musclePart: 'chest', equipment: 'dumbbell', isCompound: true, pattern: 'h-push', video: localGif('incline-dumbbell-press') },
  ...
  { id: 'cable-crossover', nameJa: 'ケーブルクロスオーバー', nameEn: 'Cable Crossover', musclePart: 'chest', equipment: 'cable', isCompound: false, pattern: 'isolation', video: localGif('cable-crossover') },
  ...
  { id: 'smith-machine-bench-press', nameJa: 'スミスマシンベンチプレス', nameEn: 'Smith Machine Bench Press', musclePart: 'chest', equipment: 'machine', isCompound: true, pattern: 'h-push', video: localGif('smith-machine-bench-press') },
  ...
  { id: 'floor-press', nameJa: 'フロアプレス', nameEn: 'Floor Press', musclePart: 'chest', equipment: 'barbell', isCompound: true, pattern: 'h-push', video: localGif('floor-press') },
  { id: 'svend-press', nameJa: 'スベンドプレス', nameEn: 'Svend Press', musclePart: 'chest', equipment: 'dumbbell', isCompound: false, pattern: 'isolation', video: localGif('svend-press') },
  ...
  { id: 'incline-push-up', nameJa: 'インクラインプッシュアップ', nameEn: 'Incline Push-Up', musclePart: 'chest', equipment: 'bodyweight', isCompound: true, pattern: 'h-push', video: localGif('incline-push-up') },
  { id: 'decline-push-up', nameJa: 'デクラインプッシュアップ', nameEn: 'Decline Push-Up', musclePart: 'chest', equipment: 'bodyweight', isCompound: true, pattern: 'h-push', video: localGif('decline-push-up') },
  ...
  { id: 'ring-dips', nameJa: 'リングディップス', nameEn: 'Ring Dips', musclePart: 'chest', equipment: 'bodyweight', isCompound: true, pattern: 'h-push', video: localGif('ring-dips') },
...
const BACK_EXERCISES: readonly ExerciseDef[] = [
  ...
  { id: 'one-arm-dumbbell-row', nameJa: 'ワンハンドロウ', nameEn: 'One-Arm Dumbbell Row', musclePart: 'back', equipment: 'dumbbell', isCompound: true, pattern: 'h-pull', video: localGif('one-arm-dumbbell-row') },
  ...
  { id: 'dumbbell-shrug', nameJa: 'ダンベルシュラッグ', nameEn: 'Dumbbell Shrug', musclePart: 'back', equipment: 'dumbbell', isCompound: false, pattern: 'isolation', video: localGif('dumbbell-shrug') },
  { id: 'straight-arm-pulldown', nameJa: 'ストレートアームプルダウン', nameEn: 'Straight-Arm Pulldown', musclePart: 'back', equipment: 'cable', isCompound: false, pattern: 'isolation', video: localGif('straight-arm-pulldown') },
  // ── new ──────────────────────────────────────────────────────────────────
  { id: 'sumo-deadlift', nameJa: 'スモウデッドリフト', nameEn: 'Sumo Deadlift', musclePart: 'back', equipment: 'barbell', isCompound: true, pattern: 'hinge', video: localGif('sumo-deadlift') },
  { id: 'trap-bar-deadlift', nameJa: 'トラップバーデッドリフト', nameEn: 'Trap Bar Deadlift', musclePart: 'back', equipment: 'barbell', isCompound: true, pattern: 'hinge', video: localGif('trap-bar-deadlift') },
  { id: 'rack-pull', nameJa: 'ラックプル', nameEn: 'Rack Pull', musclePart: 'back', equipment: 'barbell', isCompound: true, pattern: 'hinge' },
  { id: 'chin-up', nameJa: 'チンニング', nameEn: 'Chin-Up', musclePart: 'back', equipment: 'bodyweight', isCompound: true, pattern: 'v-pull', video: localGif('chin-up') },
  ...
  { id: 'inverted-row', nameJa: 'インバーテッドロウ', nameEn: 'Inverted Row', musclePart: 'back', equipment: 'bodyweight', isCompound: true, pattern: 'h-pull', video: localGif('inverted-row') },
  { id: 'renegade-row', nameJa: 'レネゲードロウ', nameEn: 'Renegade Row', musclePart: 'back', equipment: 'dumbbell', isCompound: true, pattern: 'h-pull' },
  { id: 'good-morning', nameJa: 'グッドモーニング', nameEn: 'Good Morning', musclePart: 'back', equipment: 'barbell', isCompound: true, pattern: 'hinge', video: localGif('good-morning') },
  ...
  { id: 'barbell-shrug', nameJa: 'バーベルシュラッグ', nameEn: 'Barbell Shrug', musclePart: 'back', equipment: 'barbell', isCompound: false, pattern: 'isolation', video: localGif('barbell-shrug') },
  { id: 'cable-shrug', nameJa: 'ケーブルシュラッグ', nameEn: 'Cable Shrug', musclePart: 'back', equipment: 'cable', isCompound: false, pattern: 'isolation' },
  { id: 'superman', nameJa: 'スーパーマン', nameEn: 'Superman', musclePart: 'back', equipment: 'bodyweight', isCompound: false, pattern: 'hinge', video: localGif('superman') },
...
const LEGS_EXERCISES: readonly ExerciseDef[] = [
  ...
  { id: 'romanian-deadlift', nameJa: 'ルーマニアンデッドリフト', nameEn: 'Romanian Deadlift', musclePart: 'legs', equipment: 'barbell', isCompound: true, pattern: 'hinge', video: localGif('romanian-deadlift') },
  ...
  { id: 'goblet-squat', nameJa: 'ゴブレットスクワット', nameEn: 'Goblet Squat', musclePart: 'legs', equipment: 'dumbbell', isCompound: true, pattern: 'squat', video: localGif('goblet-squat') },
  ...
  { id: 'hack-squat', nameJa: 'ハックスクワット', nameEn: 'Hack Squat', musclePart: 'legs', equipment: 'machine', isCompound: true, pattern: 'squat', video: localGif('hack-squat') },
  { id: 'smith-machine-squat', nameJa: 'スミスマシンスクワット', nameEn: 'Smith Machine Squat', musclePart: 'legs', equipment: 'machine', isCompound: true, pattern: 'squat', video: localGif('smith-machine-squat') },
  { id: 'box-squat', nameJa: 'ボックススクワット', nameEn: 'Box Squat', musclePart: 'legs', equipment: 'barbell', isCompound: true, pattern: 'squat', video: localGif('box-squat') },
  { id: 'overhead-squat', nameJa: 'オーバーヘッドスクワット', nameEn: 'Overhead Squat', musclePart: 'legs', equipment: 'barbell', isCompound: true, pattern: 'squat', video: localGif('overhead-squat') },
  ...
  { id: 'seated-leg-curl', nameJa: 'シーテッドレッグカール', nameEn: 'Seated Leg Curl', musclePart: 'legs', equipment: 'machine', isCompound: false, pattern: 'isolation', video: localGif('seated-leg-curl') },
  ...
  { id: 'seated-calf-raise', nameJa: 'シーテッドカーフレイズ', nameEn: 'Seated Calf Raise', musclePart: 'legs', equipment: 'machine', isCompound: false, pattern: 'isolation', video: localGif('seated-calf-raise') },
...
const SHOULDERS_EXERCISES: readonly ExerciseDef[] = [
  ...
  { id: 'face-pull', nameJa: 'フェイスプル', nameEn: 'Face Pull', musclePart: 'shoulders', equipment: 'cable', isCompound: false, pattern: 'isolation', video: localGif('face-pull') },
  ...
  // ── new ──────────────────────────────────────────────────────────────────
  { id: 'push-press', nameJa: 'プッシュプレス', nameEn: 'Push Press', musclePart: 'shoulders', equipment: 'barbell', isCompound: true, pattern: 'v-push', video: localGif('push-press') },
  { id: 'seated-dumbbell-press', nameJa: 'シーテッドダンベルプレス', nameEn: 'Seated Dumbbell Press', musclePart: 'shoulders', equipment: 'dumbbell', isCompound: true, pattern: 'v-push', video: localGif('seated-dumbbell-press') },
  ...
  { id: 'cable-rear-delt-fly', nameJa: 'ケーブルリアデルトフライ', nameEn: 'Cable Rear Delt Fly', musclePart: 'shoulders', equipment: 'cable', isCompound: false, pattern: 'isolation', video: localGif('cable-rear-delt-fly') },
  ...
  { id: 'cuban-press', nameJa: 'キューバンプレス', nameEn: 'Cuban Press', musclePart: 'shoulders', equipment: 'dumbbell', isCompound: false, pattern: 'isolation', video: localGif('cuban-press') },
  ...
  { id: 'internal-rotation', nameJa: 'インターナルローテーション', nameEn: 'Cable Internal Rotation', musclePart: 'shoulders', equipment: 'cable', isCompound: false, pattern: 'isolation', video: localGif('cable-internal-rotation') },
...
const ARMS_EXERCISES: readonly ExerciseDef[] = [
  ...
  { id: 'barbell-curl', nameJa: 'バーベルカール', nameEn: 'Barbell Curl', musclePart: 'arms', equipment: 'barbell', isCompound: false, pattern: 'isolation', video: localGif('barbell-curl') },
  { id: 'hammer-curl', nameJa: 'ハンマーカール', nameEn: 'Hammer Curl', musclePart: 'arms', equipment: 'dumbbell', isCompound: false, pattern: 'isolation' },
  { id: 'incline-dumbbell-curl', nameJa: 'インクラインダンベルカール', nameEn: 'Incline Dumbbell Curl', musclePart: 'arms', equipment: 'dumbbell', isCompound: false, pattern: 'isolation', video: localGif('incline-dumbbell-curl') },
  ...
  // ── new ──────────────────────────────────────────────────────────────────
  { id: 'ez-bar-curl', nameJa: 'EZバーカール', nameEn: 'EZ-Bar Curl', musclePart: 'arms', equipment: 'barbell', isCompound: false, pattern: 'isolation', video: localGif('ez-bar-curl') },
  { id: 'preacher-curl', nameJa: 'プリーチャーカール', nameEn: 'Preacher Curl', musclePart: 'arms', equipment: 'barbell', isCompound: false, pattern: 'isolation', video: localGif('preacher-curl') },
  ...
  { id: 'spider-curl', nameJa: 'スパイダーカール', nameEn: 'Spider Curl', musclePart: 'arms', equipment: 'dumbbell', isCompound: false, pattern: 'isolation', video: localGif('spider-curl') },
  { id: 'drag-curl', nameJa: 'ドラッグカール', nameEn: 'Drag Curl', musclePart: 'arms', equipment: 'barbell', isCompound: false, pattern: 'isolation', video: localGif('drag-curl') },
  { id: 'zottman-curl', nameJa: 'ゾットマンカール', nameEn: 'Zottman Curl', musclePart: 'arms', equipment: 'dumbbell', isCompound: false, pattern: 'isolation', video: localGif('zottman-curl') },
  ...
  { id: 'seated-dumbbell-curl', nameJa: 'シーテッドダンベルカール', nameEn: 'Seated Dumbbell Curl', musclePart: 'arms', equipment: 'dumbbell', isCompound: false, pattern: 'isolation', video: localGif('seated-dumbbell-curl') },
  ...
  { id: 'jm-press', nameJa: 'JMプレス', nameEn: 'JM Press', musclePart: 'arms', equipment: 'barbell', isCompound: true, pattern: 'h-push', video: localGif('jm-press') },
...
const ABS_EXERCISES: readonly ExerciseDef[] = [
  ...
  { id: 'plank', nameJa: 'プランク', nameEn: 'Plank', musclePart: 'abs', equipment: 'bodyweight', isCompound: false, pattern: 'core',
    ...
    video: localGif('plank') },
  { id: 'leg-raise', nameJa: 'レッグレイズ', nameEn: 'Leg Raise', musclePart: 'abs', equipment: 'bodyweight', isCompound: false, pattern: 'core' },
  { id: 'russian-twist', nameJa: 'ロシアンツイスト', nameEn: 'Russian Twist', musclePart: 'abs', equipment: 'bodyweight', isCompound: false, pattern: 'core', video: localGif('russian-twist') },
  { id: 'ab-roller', nameJa: 'アブローラー', nameEn: 'Ab Wheel Rollout', musclePart: 'abs', equipment: 'bodyweight', isCompound: true, pattern: 'core' },
  { id: 'hanging-leg-raise', nameJa: 'ハンギングレッグレイズ', nameEn: 'Hanging Leg Raise', musclePart: 'abs', equipment: 'bodyweight', isCompound: false, pattern: 'core', video: localGif('hanging-leg-raise') },
  { id: 'cable-crunch', nameJa: 'ケーブルクランチ', nameEn: 'Cable Crunch', musclePart: 'abs', equipment: 'cable', isCompound: false, pattern: 'core', video: localGif('cable-crunch') },
  ...
  { id: 'reverse-crunch', nameJa: 'リバースクランチ', nameEn: 'Reverse Crunch', musclePart: 'abs', equipment: 'bodyweight', isCompound: false, pattern: 'core', video: localGif('reverse-crunch') },
  ...
  { id: 'scissor-kick', nameJa: 'シザーキック', nameEn: 'Scissor Kick', musclePart: 'abs', equipment: 'bodyweight', isCompound: false, pattern: 'core', video: localGif('scissor-kick') },
  { id: 'toe-touch', nameJa: 'トゥタッチ', nameEn: 'Toe Touch', musclePart: 'abs', equipment: 'bodyweight', isCompound: false, pattern: 'core' },
  { id: 'dead-bug', nameJa: 'デッドバグ', nameEn: 'Dead Bug', musclePart: 'abs', equipment: 'bodyweight', isCompound: false, pattern: 'core', video: localGif('dead-bug') },
  ...
  { id: 'pallof-press', nameJa: 'パロフプレス', nameEn: 'Pallof Press', musclePart: 'abs', equipment: 'cable', isCompound: false, pattern: 'core', video: localGif('pallof-press') },
  { id: 'sit-up', nameJa: 'シットアップ', nameEn: 'Sit-Up', musclePart: 'abs', equipment: 'bodyweight', isCompound: false, pattern: 'core', video: localGif('sit-up') },
